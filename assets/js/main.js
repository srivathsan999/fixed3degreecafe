(function () {
  ...
  const navToggleButtons = selectAll("[data-nav-toggle]");
  const navClose = select("[data-nav-close]");
  ...
  navToggleButtons.forEach((btn) => btn.addEventListener("click", () => toggleNav()));
  navClose?.addEventListener("click", () => toggleNav(true));
